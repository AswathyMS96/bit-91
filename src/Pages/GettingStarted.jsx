...
import { GroupSvg } from "./SupportSvg";
import QA from "./QA";
  ...
  return (
    ...
    >
      <div className="w-[100vw] h-fit py-20 flex flex-col items-center justify-center font-fits font-normal text-base">
        <div className="flex flex-col items-center justify-center gap-5">
          ...
          <motion.p
            ...
            transition={{ duration: 0.5, ease: "circOut" }}
            className="lg:text-5xl flex flex-row gap-2 items-center text-3xl font-bold text-[#000000] mt-6"
          >
            <span>
              <GroupSvg />
            </span>
      ...
      <div className="bg-contactBg bg-contain xl:h-[368px] lg:h-[280px] md:h-[200px] h-[150px] mb-3  bg-no-repeat lg:mx-32 md:mx-16 md:mb-5 mt-10 lg:mb-10 mx-5 relative">
        <div className="flex flex-col justify-center items-center font-fits md:gap-6 gap-3 absolute lg:left-[50%] 2xl:left-[40%] md:left-[40%] sm:left-[29%] left-[40%] sm:top-[30%] top-[20%]">
